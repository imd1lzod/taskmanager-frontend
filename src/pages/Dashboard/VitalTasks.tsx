...
export default function VitalTasks() {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Muhim Vazifalar</h1>
        <p className="text-gray-600 mt-2">Darhol e'tibor berilishi kerak bo'lgan yuqori muhimlikdagi vazifalar</p>
      </div>
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
            <CardHeader>
              <div className="flex items-center space-x-2">
                <CardTitle className="text-xl font-bold text-slate-900">Muhim Vazifalar</CardTitle>
                <div className="h-1 w-16 bg-gradient-to-r from-red-500 to-pink-500 rounded-full"></div>
              </div>
              <p className="text-sm text-gray-600 mt-1">Darhol e'tibor berilishi kerak bo'lgan yuqori muhimlikdagi vazifalar</p>
            </CardHeader>
            <CardContent className="space-y-6">
              {isLoading ? (
                ...
                <div 
                  key={task.id} 
                  className={`group relative border border-gray-200 rounded-xl p-6 cursor-pointer hover:shadow-xl transition-all duration-300 bg-white hover:bg-gradient-to-r hover:from-red-50/50 hover:to-pink-50/50 hover:border-red-300 hover:scale-[1.02] ${
                    selectedTask?.id === task.id ? 'ring-2 ring-red-500 bg-red-50/80 shadow-lg' : ''
                  }`}
                ...
                >
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="ml-6 flex-shrink-0">
                      <div className="w-16 h-16 bg-gradient-to-br from-red-100 to-pink-100 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  ...
                  <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="flex space-x-2">
                      <button 
                        className="p-2 bg-white/80 hover:bg-red-50 rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
                        onClick={(e) => {
                          e.stopPropagation()
                      ...
                      >
                        <Edit className="h-4 w-4 text-gray-600 hover:text-red-600" />
                      </button>
        ...
        <div>
          {selectedTask ? (
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent className="space-y-6">
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Qisqa Tavsif</h3>
